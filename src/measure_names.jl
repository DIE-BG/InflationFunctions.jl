...
MEASURE_NAMES = Dict(
    ...
    (:english, :InflationGSEq) => "Unweighted Gaussian Smoothing ",
    (:spanish, :InflationGSWeighted) => "Suavizamiento gaussiano ponderado ",
    (:english, :InflationGSWeighted) => "Weighted Gaussian Smoothing ",
    ...
    (:spanish, :InflationTrimmedMeanWeighted) => "Media truncada ponderada ",
